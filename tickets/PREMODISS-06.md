...
Update existing E2E tests for new ensemble semantics and add new unit tests specified in the spec.
...
- `test/e2e/helpers/mock-fitness.js` — update for new scoring return shape if needed

## Out of scope

- Source code changes (all done in PREMODISS-01 through 05)
- Unit tests (handled within their respective tickets)
- Any non-test file
