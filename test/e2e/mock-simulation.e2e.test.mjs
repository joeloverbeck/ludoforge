...
test("mock simulation returns a terminal outcome within the turn cap", async () => {
...
test("mock simulation uses a max-turns cutoff for non-terminating scenarios", async () => {
...
test("mock simulation output is deterministic for the same seed", async () => {
