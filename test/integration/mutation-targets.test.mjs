...
test("collectVariableTargets includes variables and token attributes in order", () => {
...
test("collectActionTargets returns action entries and handles missing lists", () => {
...
test("collectActionEffectTargets yields costs and effects with indices", () => {
  const definition = {
    actions: [
      {
        id: "act",
...
test("collectZoneTargets and collectTokenTypeTargets handle empty state", () => {
