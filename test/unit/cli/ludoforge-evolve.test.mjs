...
test("dry-run validates inputs without running the runner or writing metadata", async () => {
...
test("resume uses loadResumeState and continues from the next generation", async () => {
...
test("new run writes metadata and passes seed population into the runner", async () => {
