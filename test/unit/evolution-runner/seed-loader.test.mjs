...
describe("seed-loader", () => {
  describe("loadSeedPopulation", () => {
    describe("JSON format", () => {
      it("loads JSON seed arrays in order", async () => {
    ...
    describe("JSONL format", () => {
      it("loads JSONL seeds in order", async () => {
        const dir = await createTempDir();
    ...
    describe("directory loading", () => {
      it("loads directory files in sorted order", async () => {
        const dir = await createTempDir();
    ...
    describe("validation", () => {
      it("rejects seeds missing id or definition", async () => {
        const dir = await createTempDir();
