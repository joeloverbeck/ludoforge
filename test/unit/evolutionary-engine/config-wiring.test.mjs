...
test("DEFAULT_MAP_ELITES_CONFIG is a valid object with expected properties", () => {
...
test("DEFAULT_MAP_ELITES_CONFIG descriptors have valid binning fields", () => {
...
test("defaultMutationOperators has 14 entries matching config mutation.enabled", () => {
...
test("defaultCrossoverOperators contains subtree-swap from config", () => {
...
test("defaultRepairOperators contains dsl-safety from config", () => {
