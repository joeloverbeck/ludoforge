...
test("runRollout simulates from the provided state and keeps input immutable", () => {
...
test("runRollout is deterministic when seeded", () => {
  const definition = createBaseDefinition();
...
test("runRollout rejects missing required inputs", () => {
  const definition = createBaseDefinition();
  const state = createInitialState(definition);
