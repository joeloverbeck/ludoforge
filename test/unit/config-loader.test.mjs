...
test("loadConfigSet loads default configs and builds a fingerprint", async () => {
...
test("loadConfigFile reports schema violations for invalid config", async () => {
...
test("createConfigFingerprint is deterministic for equivalent objects", () => {
  const left = {
    b: 2,
    a: { d: 4, c: 3 },
    list: [{ z: 1, y: 2 }],
