...
describe("trajectory-log-store", () => {
  ...
  describe("writeTrajectoryLogJsonl / readTrajectoryLogJsonl", () => {
    it("writes and reads trajectory log JSONL", async () => {
  ...
  describe("serializeTrajectoryLogRecord", () => {
    it("serialization is deterministic for equivalent trajectory records", () => {
      const recordA = {
        ...baseRecord,
        trajectory: {
          steps: [
  ...
  describe("applyTrajectoryLogRetention", () => {
    it("retention policy keeps the most recent records", () => {
      const records = [
    ...
    it("retention policy respects size caps", () => {
      const records = [
        { ...baseRecord, id: "trajectory-1", runId: "run-1" },
        { ...baseRecord, id: "trajectory-2", runId: "run-2" },
      ];
