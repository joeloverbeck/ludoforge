...
test("combineFitnessScores uses full cap after bootstrap threshold", () => {
...
test("combineFitnessScores skips preference when disabled and applies diversity weight", () => {
